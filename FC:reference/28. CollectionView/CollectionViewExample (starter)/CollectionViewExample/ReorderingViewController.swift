...
final class ReorderingViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    setupFlowLayout()
    setupLongPressGestureRecongnizer()
  }
  ...
  // MARK: Setup Gesture
    func setupLongPressGestureRecongnizer() {
...
extension ReorderingViewController: UICollectionViewDataSource {
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    func collectionView(_ collectionView: UICollectionView, moveItemAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        ...
        // Long Press Gesture 실행했을 때
        // beginInterativeMovementForItem 등에서 UI 작업을 할 것이라고 알고 있기 때문에
        // reloadData나 cell delete/inset 등의 UI 작업을 별도로 하지 않고
        // 데이터만 추가하면 된다.
    }
}
